...
## Expected dataset structure for [PASCAL Context (PC-59)](https://cs.stanford.edu/~roozbeh/pascal-context/), [PASCAL Context Full (PC-459)](https://cs.stanford.edu/~roozbeh/pascal-context/) and [PASCAL VOC (PAS-21)](http://host.robots.ox.ac.uk/pascal/VOC/):
...
Download the dataset from http://host.robots.ox.ac.uk/pascal/VOC/ and annotation from https://cs.stanford.edu/~roozbeh/pascal-context/
```bash
cd $DETECTRON2_DATASETS
