...
class EOV_SEG(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        self.cfg = cfg
        self.device = torch.device(cfg.MODEL.DEVICE)
        self.in_features = cfg.MODEL.EOV_SEG.IN_FEATURES
        self.num_classes = cfg.MODEL.EOV_SEG.NUM_CLASSES
        self.num_proposals = cfg.MODEL.EOV_SEG.NUM_PROPOSALS
        self.object_mask_threshold = cfg.MODEL.EOV_SEG.TEST.OBJECT_MASK_THRESHOLD
        self.overlap_threshold = cfg.MODEL.EOV_SEG.TEST.OVERLAP_THRESHOLD
        ...
        class_weight = cfg.MODEL.EOV_SEG.CLASS_WEIGHT
        dice_weight = cfg.MODEL.EOV_SEG.DICE_WEIGHT
        mask_weight = cfg.MODEL.EOV_SEG.MASK_WEIGHT
        ...
        criterion = SetCriterion(
            ...
            eos_coef=cfg.MODEL.EOV_SEG.NO_OBJECT_WEIGHT,
            losses=loss_list,
            num_points=cfg.MODEL.EOV_SEG.TRAIN_NUM_POINTS,
        ...
        self.geometric_ensemble_alpha = cfg.MODEL.OV_HEAD.GEOMETRIC_ENSEMBLE_ALPHA
        self.geometric_ensemble_beta = cfg.MODEL.OV_HEAD.GEOMETRIC_ENSEMBLE_BETA
        self.ensemble_on_valid_mask = cfg.MODEL.OV_HEAD.ENSEMBLE_ON_VALID_MASK
    ...
    def forward(self, batched_inputs):
        ...
        cnn_feats = self.cnn_backbone(images.tensor)
        vit_feats = self.vit_backbone(images.tensor)
